...
def data_request():
    ...
    try:
        response_cloud.raise_for_status()
    except requests.exceptions.HTTPError as err:
        raise ValueError(f'Cloud data request failed with error {err}')
    ...
    # Check for errors in the response
    try:
        response_astronomy.raise_for_status()
    except requests.exceptions.HTTPError as err:
        raise ValueError(f'Sunrise and sunset query failed with error {err}')
